...
<header class="nexmoe-nav">
    <div class="navSize">
			...
			<div class="nav_menu">
				<ul class="menu_ul">
					<li class="menu_li"><a href="https://5mayrain.github.io/" target="_blank">Contact</a></li>
					<li class="menu_li"><a href="https://drive.google.com/" target="_blank">GoogleDrive</a></li>
				</ul>
	  ...
	  <ul class="mdui-list"> 
	   <li class="mdui-list-item th"> 
	    <div class="mdui-col-xs-12 mdui-col-sm-7">
	     Name <i class="mdui-icon material-icons icon-sort" data-sort="date" data-order="downward">expand_more</i>
	    </div> 
	    <div class="mdui-col-sm-3 mdui-text-right">
	     Time <i class="mdui-icon material-icons icon-sort" data-sort="date" data-order="downward">expand_more</i>
	    </div> 
